...
div(class="flex flex-col justify-center w-[80%] ")
    ...
    div(class="flex flex-col py-4 w-[100%] ")
        div(class=" py-2 ")
            button(
                class=" px-2 py-4 min-w-[120px] " +
                " bg-gradient-to-r from-indigo-700 from-80% to-blue-700 "
                hx-boost="true" hx-post="#{self.newAccount}" hx-ext="json-enc"
            ) 
        ...
        div(class=" py-2 ")
            button(
                class=" px-2 py-4 min-w-[120px] " +
                " bg-gradient-to-r from-indigo-700 from-80% to-blue-700 "
                hx-boost="true" hx-get="#{self.logout}" hx-ext="json-enc"
            ) 
            ...
            ul
                each val in self.accounts
                    li(class="bg-gradient-to-r from-indigo-200 from-80% to-blue-200")
                        a(href="/account/#{val.uuid}") Account #{val.uuid} With $#{val.cents}
`
